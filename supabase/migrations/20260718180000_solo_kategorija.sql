-- =====================================================================
-- TVS · 0027 · Kategorija sa jednim prijavljenim: pobednik „bez borbe"
-- Pravilo saveza: ako je u kategoriji samo JEDAN prijavljen igrač (član),
-- on je pobednik svoje kategorije bez borbe i dobija bodove pobednika
-- (kostur 8). Sudija ga po želji DODATNO prijavi u jaču kategoriju
-- („Dodaj i u jaču" u portalu) — tamo osvaja bodove po rezultatu,
-- pa igrač dobija bodove i u svojoj i u jačoj kategoriji.
-- finish_tournament v4 = v3 (gost bez bodova) + solo-kategorija obračun.
-- =====================================================================
